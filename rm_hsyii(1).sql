...
CREATE TABLE `member` (
  ...
  `image` varchar(120) CHARACTER SET utf8 DEFAULT NULL COMMENT '头像',
...
-- Records of member
-- ----------------------------
INSERT INTO `member` VALUES ('7', 'test', '金木研', '学生', '男', '4444455588', '1008688', '2022-03-29', 'test', '10000', 'tset', '审核通过', 'jpg_A_625c3a34ec1506.94702695.png', '1');
INSERT INTO `member` VALUES ('8', 'test', '桐谷和人', '学生', '男', '4444455588', '1008688', '2022-03-29', 'test', '10000', 'tset', '待审核', 'jpg_A_625c3a3e2ee683.68330768.png', '1');
INSERT INTO `member` VALUES ('9', 'ggg', '艾伦', '学生', '男', '4444455588', '1008688', '2022-03-29', 'test', '10000', 'tset', '审核不通过', 'jpg_A_625c3a621e4c65.62590965.png', '1');
...
-- Records of menu
-- ----------------------------
INSERT INTO `menu` VALUES ('1', '1', 'A', '资源', '100000', 'RoboMaster资源管理', 'source/index', 'A01');
...
INSERT INTO `menu` VALUES ('16', '1', 'A', '权限管理', '100009', '角色权限设置', 'Role/index', 'E01');
INSERT INTO `menu` VALUES ('17', '1', 'A', '权限管理', '100010', '角色管理', 'RoleManagement/index', 'E02');
...
CREATE TABLE `myclass` (
  ...
  `image` varchar(55) CHARACTER SET utf8 DEFAULT NULL COMMENT '课程图片',
  `file` varchar(55) CHARACTER SET utf8 DEFAULT NULL COMMENT '文件',
...
-- Records of myclass
-- ----------------------------
INSERT INTO `myclass` VALUES ('8', '超级工厂建造工程', 'unit2工程绘图及测量', '介绍课', '2022-03-27 00:00:00', '2022-03-29 00:00:00', '2天', '项目持续时间为30小时（90分钟*20次课），最后两节课为作品分享（120分钟），包括在30小时课程中', '', '', '20节课', '猎罪图鉴', 'jpg_A_6240278cb9cf23.69801666.jpg', 'jpg_A_6240278ed3d011.70213734.jpg', '');
INSERT INTO `myclass` VALUES ('7', '超级工厂建造工程', '记名', '介绍课', '2022-03-27 00:00:00', '2022-03-29 00:00:00', '2天', '项目持续时间为30小时（90分钟*20次课），最后两节课为作品分享（120分钟），包括在30小时课程中', '2022-04-06 23:00-23:40', '计算机学院630', '20节课', '无记名', 'jpg_A_6240277ac0b379.21045796.jpg', 'jpg_A_6240277c854354.85848140.jpg', '1008611');
INSERT INTO `myclass` VALUES ('10', '超级工厂建造工程', 'unit2', '理论课', '2022-04-06 00:00:00', '2022-04-07 00:00:00', '1天', '项目持续时间为30小时（90分钟*20次课），最后两节课为作品分享（120分钟），包括在30小时课程中', '2022-04-06 23:00-23:40', '计算机学院630', '2节课', '无记名', 'jpg_A_624d36d99fbee9.00778998.png', 'jpg_A_624d36dd6bf9e6.64837314.png', '100001');
...
CREATE TABLE `project` (
  ...
  `project_last_time` datetime DEFAULT NULL COMMENT '工程持续时间',
  ...
  `image` varchar(55) CHARACTER SET utf8 DEFAULT NULL COMMENT '设想图',
  `arrangement_file` varchar(55) CHARACTER SET utf8 DEFAULT NULL COMMENT '文件',
...
-- Records of project
-- ----------------------------
INSERT INTO `project` VALUES ('2', 'test', '2022-04-01 00:00:00', '2022-04-01 00:00:00', '2022-04-01 00:00:00', 'test', 'test', '1', '数学', 'test', 'test', 'test', 'test', 'test', 'test', 'jpg_A_6251a2621aa809.96240606.jpg', 'jpg_A_6251a24c63ab26.95357756.jpg', 'test');
INSERT INTO `project` VALUES ('3', 'test', '2022-04-09 00:00:00', '2022-04-09 00:00:00', '2022-04-09 00:00:00', 'test', 'test', '1', '数据结构', 'test', 'test', 'test', 'test', 'test', 'test', 'jpg_A_6251a26bc4de77.31288749.jpg', 'jpg_A_6251a25376ced5.52274173.jpg', 'test');
...
CREATE TABLE `role_data` (
  ...
  `f_tcode` varchar(10) DEFAULT '' COMMENT '一级菜单',
  `f_mname` varchar(20) DEFAULT '' COMMENT '名称',
  `f_mcode` varchar(20) DEFAULT '' COMMENT '菜单编码',
  `f_group` varchar(20) DEFAULT '' COMMENT '分组',
  `f_no` varchar(10) DEFAULT '' COMMENT '变换',
  `f_show` int(4) DEFAULT '1' COMMENT '显示标识，0 不显示 1 显示',
  `f_mid` int(4) DEFAULT '0' COMMENT '菜单ID',
  `f_rid` int(4) DEFAULT '0' COMMENT '角色ID',
  `f_pid` int(4) DEFAULT '0' COMMENT '父亲角色ID',
  `f_tmpmark` int(4) DEFAULT '0' COMMENT '临时标识',
  `f_url` varchar(100) DEFAULT NULL,
  `f_time` datetime DEFAULT NULL COMMENT '更新日期',
  PRIMARY KEY (`f_id`)
...
-- ----------------------------
INSERT INTO `role_data` VALUES ('1', '101002', '顾客信息', 'A', '顾客总览', 'A01', '1', '0', '0', '0', '0', 'customPages/index', null);
INSERT INTO `role_data` VALUES ('2', '101002003', '工单提交', 'A', '工单管理', 'A02', '1', '0', '0', '0', '0', 'homeMenu/index', null);
INSERT INTO `role_data` VALUES ('3', '101002009', '工单审批', 'A', '工单管理', 'A03', '1', '0', '0', '0', '0', 'SysConfig/index', null);
INSERT INTO `role_data` VALUES ('4', '101002010', '工单查询', 'A', '工单管理', 'B00', '1', '0', '0', '0', '0', 'navs/index', null);
INSERT INTO `role_data` VALUES ('5', '101002014', '宝石类型维护', 'A', '证书管理', 'B01', '1', '0', '0', '0', '0', 'friendLink/index', null);
INSERT INTO `role_data` VALUES ('6', '101002036', '货品证书维护', 'A', '证书管理', 'B02', '1', '0', '0', '0', '0', 'resources/index', null);
INSERT INTO `role_data` VALUES ('7', '101002041', '产品信息', 'A', '产品管理', 'B03', '1', '0', '0', '0', '0', 'messages/index', null);
INSERT INTO `role_data` VALUES ('8', '101002043', '订单管理', 'A', '订单管理', 'B04', '1', '0', '0', '0', '0', 'homeMenus/index', null);
INSERT INTO `role_data` VALUES ('9', '101002061', '成本维护', 'A', '财务维护', 'B05', '1', '0', '0', '0', '0', 'styles/index', null);
INSERT INTO `role_data` VALUES ('10', '101002165', '流水管理', 'A', '财务维护', 'B06', '1', '0', '0', '0', '0', 'datacats/index', null);
INSERT INTO `role_data` VALUES ('11', '101002150', '库存管理', 'A', '财务维护', 'B07', '1', '0', '0', '0', '0', 'mbileBtns/index', null);
INSERT INTO `role_data` VALUES ('12', '101002195', '财务分析', 'A', '财务维护', 'B08', '1', '0', '0', '0', '0', 'switchs/index', null);
INSERT INTO `role_data` VALUES ('13', '101002305', '用户管理', 'A', '系统管理', 'B09', '1', '0', '0', '0', '0', 'feedbacks/index', null);
INSERT INTO `role_data` VALUES ('14', '101002168', '角色管理', 'A', '系统管理', 'B10', '1', '0', '0', '0', '0', 'datas/index', null);
INSERT INTO `role_data` VALUES ('15', '101022004', '流程节点标签配置', 'A', '系统管理', 'B11', '1', '0', '0', '0', '0', 'role/index', null);
INSERT INTO `role_data` VALUES ('16', '101022005', '货品类别', 'A', '系统维护', 'B12', '1', '0', '0', '0', '0', 'users/index', null);
INSERT INTO `role_data` VALUES ('17', '101029', '货品名称', 'A', '系统维护', 'C01', '1', '0', '0', '0', '0', 'articles/index', null);
INSERT INTO `role_data` VALUES ('18', '101029030', '宝石类型', 'A', '系统维护', 'C03', '1', '0', '0', '0', '0', 'articleCats/index', null);
INSERT INTO `role_data` VALUES ('19', '101029031', '库存类型', 'A', '系统维护', 'C10', '1', '0', '0', '0', '0', ' ', null);
INSERT INTO `role_data` VALUES ('20', '101038', '设计风格', 'A', '系统维护', 'C12', '1', '0', '0', '0', '0', 'logorders/index', null);
INSERT INTO `role_data` VALUES ('21', '101038006', '客户类型', 'A', '系统维护', 'C14', '1', '0', '0', '0', '0', 'logUser/index', null);
INSERT INTO `role_data` VALUES ('22', '101038007', '进店类型', 'A', '系统维护', 'C18', '1', '0', '0', '0', '0', 'logOperates/index', null);
INSERT INTO `role_data` VALUES ('23', '101038185', '用途', 'A', '系统维护', 'C20', '1', '0', '0', '0', '0', 'logSms/index', null);
INSERT INTO `role_data` VALUES ('24', '115027', '送人用途', 'A', '系统维护', 'C25', '1', '0', '0', '0', '0', ' ', null);
INSERT INTO `role_data` VALUES ('25', '115027037', '支付方式', 'A', '系统维护', 'C28', '1', '0', '0', '0', '0', ' ', null);
INSERT INTO `role_data` VALUES ('26', '115027302', '金属材质', 'A', '系统维护', 'C30', '1', '0', '0', '0', '0', ' ', null);
INSERT INTO `role_data` VALUES ('27', '115028', '收款类型', 'A', '系统维护', 'C50', '1', '0', '0', '0', '0', ' ', null);
INSERT INTO `role_data` VALUES ('28', '115028011', '工单类型', 'A', '系统维护', 'C55', '1', '0', '0', '0', '0', 'dxads/index', null);
INSERT INTO `role_data` VALUES ('29', '115028042', '广告位置', 'A', '广告管理', 'C60', '0', '0', '0', '0', '0', 'adpositions/index', null);
INSERT INTO `role_data` VALUES ('30', '115057', '推荐管理', 'A', '推荐管理', 'C65', '0', '0', '0', '0', '0', ' ', null);
INSERT INTO `role_data` VALUES ('31', '115057058', '商品推荐', 'A', '推荐管理', 'C68', '0', '0', '0', '0', '0', 'recommends/index', null);
INSERT INTO `role_data` VALUES ('32', '115057059', '店铺推荐', 'B', '推荐管理', 'C80', '0', '0', '0', '0', '0', 'baseInfo/showCheck', null);
INSERT INTO `role_data` VALUES ('33', '115057060', '品牌推荐', 'B', '推荐管理', 'C85', '0', '0', '0', '0', '0', 'baseInfo/updatepublic', null);
INSERT INTO `role_data` VALUES ('34', '115093', '促销管理', 'B', '促销管理', 'C90', '0', '0', '0', '0', '0', 'baseInfo/indexpublic', null);
INSERT INTO `role_data` VALUES ('35', '115300', '会员充值', 'B', '会员充值', 'C92', '0', '0', '0', '0', '0', 'baseInfo/indexpublic', null);
INSERT INTO `role_data` VALUES ('36', '115300172', '充值设置', 'B', '会员充值', 'C93', '0', '0', '0', '0', '0', 'chargeItems/index', null);
INSERT INTO `role_data` VALUES ('37', '115300301', '充值列表', 'B', '会员充值', ' ', '0', '0', '0', '0', '0', ' ', null);
INSERT INTO `role_data` VALUES ('38', '117071', '统计报表', 'C', '统计报表', ' ', '0', '0', '0', '0', '0', ' ', null);
INSERT INTO `role_data` VALUES ('39', '117071072', '商品销售排行', 'C', '统计报表', 'D01', '0', '0', '0', '0', '0', 'baseInfo/index2', null);
INSERT INTO `role_data` VALUES ('40', '117071073', '新增会员统计', 'C', '统计报表', 'D03', '0', '0', '0', '0', '0', 'baseInfo/tuihui', null);
INSERT INTO `role_data` VALUES ('41', '117071074', '销售额统计', 'C', '统计报表', 'D10', '0', '0', '0', '0', '0', 'baseInfo/waitTocheck', null);
INSERT INTO `role_data` VALUES ('42', '117071075', '会员登录统计', 'C', '统计报表', 'D13', '0', '0', '0', '0', '0', 'logUser/index', null);
INSERT INTO `role_data` VALUES ('43', '117071076', '销售订单统计', 'C', '统计报表', 'D15', '0', '0', '0', '0', '0', 'baseInfo/check&type=2', null);
INSERT INTO `role_data` VALUES ('44', '117071077', '店铺销售统计', 'C', '统计报表', 'D18', '0', '0', '0', '0', '0', 'baseInfo/check&type=3', null);
INSERT INTO `role_data` VALUES ('45', '117071325', '充值统计报表', 'C', '统计报表', 'D20', '0', '0', '0', '0', '0', 'baseInfo/checked', null);
INSERT INTO `role_data` VALUES ('46', '117071326', '提现统计报表', 'C', '统计报表', ' ', '0', '0', '0', '0', '0', 'baseInfo/returnChange', null);
INSERT INTO `role_data` VALUES ('47', '126018', '会员管理', 'D', '会员管理', 'D25', '0', '0', '0', '0', '0', 'member/index', null);
INSERT INTO `role_data` VALUES ('48', '126018019', '会员等级', 'D', '会员管理', 'D28', '0', '0', '0', '0', '0', 'ranks/index', null);
INSERT INTO `role_data` VALUES ('49', '126018020', '会员积分', 'D', '会员管理', 'D30', '0', '0', '0', '0', '0', 'baseInfo/waitzjCheck', null);
INSERT INTO `role_data` VALUES ('50', '126018021', '账号管理', 'D', '会员管理', 'D35', '0', '0', '0', '0', '0', 'baseInfo/zjCheck', null);
INSERT INTO `role_data` VALUES ('51', '126018351', '账号消费信息', 'D', '会员管理', 'D40', '0', '0', '0', '0', '0', 'baseInfo/zjCheckstate', null);
INSERT INTO `role_data` VALUES ('52', '135008', '用户收货地址', 'E', '购物设置', 'D45', '0', '0', '0', '0', '0', 'userAddress/index', null);
INSERT INTO `role_data` VALUES ('53', '135008012', '支付管理', 'E', '购物设置', 'D60', '0', '0', '0', '0', '0', 'payments/index', null);
INSERT INTO `role_data` VALUES ('54', '135008013', '银行管理', 'E', '购物设置', 'D65', '0', '0', '0', '0', '0', 'banks/index', null);
INSERT INTO `role_data` VALUES ('55', '135008016', '地区管理', 'E', '购物设置', 'D80', '0', '0', '0', '0', '0', 'areas/index', null);
INSERT INTO `role_data` VALUES ('56', '135008053', '快递管理', 'E', '购物设置', 'D801', '0', '0', '0', '0', '0', 'express/index', null);
INSERT INTO `role_data` VALUES ('57', '135008086', '消息模板', 'E', '购物设置', 'D802', '0', '0', '0', '0', '0', 'templatemsgs/index', null);
INSERT INTO `role_data` VALUES ('58', '135008303', '通知设置', 'E', '购物设置', ' ', '0', '0', '0', '0', '0', ' ', null);
INSERT INTO `role_data` VALUES ('59', '135008303', '购物查询', 'E', '购物设置', 'E01', '0', '0', '0', '0', '0', 'carts/index', null);
INSERT INTO `role_data` VALUES ('60', '135023', '商品管理', 'E', '商品管理', 'E03', '0', '0', '0', '0', '0', 'goods/index', null);
INSERT INTO `role_data` VALUES ('61', '135023024', '商品分类', 'E', '商品管理', 'E10', '0', '0', '0', '0', '0', 'goodscats/index', null);
INSERT INTO `role_data` VALUES ('62', '135023025', '品牌管理', 'E', '商品管理', 'E12', '0', '0', '0', '0', '0', 'brands/index', null);
INSERT INTO `role_data` VALUES ('63', '135023032', '商品规格', 'E', '商品管理', 'E15', '1', '0', '0', '0', '0', 'goodsspecs/index', null);
INSERT INTO `role_data` VALUES ('64', '135023033', '已上架商品', 'E', '商品管理', 'E18', '0', '0', '0', '0', '0', 'baseInfo/check&type=3', null);
INSERT INTO `role_data` VALUES ('65', '135023034', '评价管理', 'E', '商品管理', 'E20', '0', '0', '0', '0', '0', 'goodsAppraises/index', null);
INSERT INTO `role_data` VALUES ('66', '135023048', '商品属性', 'E', '商品管理', 'E25', '0', '0', '0', '0', '0', 'specitems/index', null);
INSERT INTO `role_data` VALUES ('67', '135023054', '待审核商品', 'E', '商品管理', 'E28', '0', '0', '0', '0', '0', 'baseInfo/passed', null);
INSERT INTO `role_data` VALUES ('68', '135023055', '商品评分', 'E', '商品管理', 'E30', '0', '0', '0', '0', '0', 'goodsScores/index', null);
INSERT INTO `role_data` VALUES ('69', '135023168', '商品咨询', 'E', '商品管理', 'E50', '0', '0', '0', '0', '0', 'goodsConsult/index', null);
INSERT INTO `role_data` VALUES ('70', '135023188', '举报管理', 'E', '商品管理', 'E55', '0', '0', '0', '0', '0', 'Informs/index', null);
INSERT INTO `role_data` VALUES ('71', '135039', '店铺管理', 'M', '店铺管理', 'E60', '0', '0', '0', '0', '0', 'shops/index', null);
INSERT INTO `role_data` VALUES ('72', '135039044', '店铺认证', 'M', '店铺管理', 'E65', '0', '0', '0', '0', '0', 'baseInfo/zjCheckPass', null);
INSERT INTO `role_data` VALUES ('73', '135039045', '开店申请', 'M', '店铺管理', 'E68', '0', '0', '0', '0', '0', 'baseInfo/zjChecknoPass', null);
INSERT INTO `role_data` VALUES ('74', '135039046', '店铺管理', 'M', '店铺管理', 'E80', '0', '0', '0', '0', '0', 'shops/index', null);
INSERT INTO `role_data` VALUES ('75', '135039047', '停用店铺', 'M', '店铺管理', '', '0', '0', '0', '0', '0', '', null);
INSERT INTO `role_data` VALUES ('76', '135039220', '店铺风格管理', 'M', '店铺风格', 'F01', '0', '0', '0', '0', '0', 'baseInfo/indexVerifybm2', null);
INSERT INTO `role_data` VALUES ('77', '135039335', '店铺公告', 'M', '店铺风格', 'F02', '0', '0', '0', '0', '0', 'baseInfo/indexpublic', null);
INSERT INTO `role_data` VALUES ('78', '135039336', '店铺帮助', 'M', '店铺风格', 'F03', '0', '0', '0', '0', '0', 'baseInfo/updatepublic', null);
INSERT INTO `role_data` VALUES ('79', '135039337', '入驻指南', 'M', '入驻', 'F04', '0', '0', '0', '0', '0', 'baseInfo/indexpublic', null);
INSERT INTO `role_data` VALUES ('80', '135039350', '前端首页显示设置', 'M', '入驻', 'F05', '0', '0', '0', '0', '0', 'customPages/index', null);
INSERT INTO `role_data` VALUES ('81', '135049', '订单管理', 'E', '订单管理', '', '0', '0', '0', '0', '0', '', null);
INSERT INTO `role_data` VALUES ('82', '135049050', '订单管理', 'E', '订单管理', 'F05', '0', '0', '0', '0', '0', 'baseInfo/updatepublic', null);
INSERT INTO `role_data` VALUES ('83', '135049051', '投诉订单', 'E', '订单管理', 'F06', '0', '0', '0', '0', '0', 'baseInfo/indexpublic', null);
INSERT INTO `role_data` VALUES ('84', '135049052', '退款订单', 'E', '订单管理', 'F07', '0', '0', '0', '0', '0', 'orderRefunds/index', null);
INSERT INTO `role_data` VALUES ('85', '135071328', '积分抵扣报表', 'E', '订单管理', 'F08', '0', '0', '0', '0', '0', 'goodsScores/index', null);
INSERT INTO `role_data` VALUES ('86', '135071329', '订单销售额统计', 'E', '销售额统计', 'G01', '0', '0', '0', '0', '0', 'baseCode/index', null);
INSERT INTO `role_data` VALUES ('87', '156062', '提现信息', 'F', '财务管理', 'G05', '0', '0', '0', '0', '0', 'cashConfigs/index', null);
INSERT INTO `role_data` VALUES ('88', '156062063', '提现申请', 'F', '财务管理', 'G10', '0', '0', '0', '0', '0', 'CashDraws/index', null);
INSERT INTO `role_data` VALUES ('89', '156062064', '结算申请', 'F', '财务管理', 'G15', '0', '0', '0', '0', '0', 'TeacherBase/indexrole', null);
INSERT INTO `role_data` VALUES ('90', '156062065', '支付测试', 'F', '支付管理', 'G30', '0', '0', '0', '0', '0', 'logPayparams/index', null);
INSERT INTO `role_data` VALUES ('91', '156062085', '资金管理', 'F', '支付管理', 'G35', '0', '0', '0', '0', '0', 'teacherBase/indexrolebm', null);
INSERT INTO `role_data` VALUES ('92', '181082', '扩展管理', 'G', '应用管理', 'G38', '0', '0', '0', '0', '0', 'teacherBase/indexrolebm', null);
INSERT INTO `role_data` VALUES ('93', '181082083', '插件管理', 'G', '应用管理', 'G10', '0', '0', '0', '0', '0', 'addons/index', null);
INSERT INTO `role_data` VALUES ('94', '181082084', '钩子管理', 'G', '应用管理', 'G15', '0', '0', '0', '0', '0', 'hooks/index', null);
INSERT INTO `role_data` VALUES ('104', '104010', '投诉管理', 'K', '投诉管理', 'G30', '0', '0', '0', '0', '0', 'orderComplains/index', null);
INSERT INTO `role_data` VALUES ('105', '181082080', '任务管理', 'G', '应用管理', 'G35', '0', '0', '0', '0', '0', 'crons/index', null);
INSERT INTO `role_data` VALUES ('106', '181082085', '用户收藏或关注', 'K', '投诉管理', 'G35', '0', '0', '0', '0', '0', 'favorites/index', null);
INSERT INTO `role_data` VALUES ('107', '135023035', '虚拟商品', 'E', '商品管理', 'E22', '0', '0', '0', '0', '0', 'goodsVirtuals/index', null);
INSERT INTO `role_data` VALUES ('108', '156062090', '付款记录', 'F', '财务管理', 'G35', '0', '0', '0', '0', '0', 'logMoneys/index', null);
INSERT INTO `role_data` VALUES ('109', '181082087', '快递管理', 'K', '投诉管理', 'G36', '0', '0', '0', '0', '0', 'orderexpress/index', null);
INSERT INTO `role_data` VALUES ('110', '156062', '提现信息', 'F', '财务管理', 'G05', '0', '0', '0', '0', '0', 'cashConfigs/index', null);
INSERT INTO `role_data` VALUES ('111', '156062063', '提现申请', 'F', '财务管理', 'F40', '0', '0', '0', '0', '0', 'CashDraws/index', null);
INSERT INTO `role_data` VALUES ('112', '156062064', '结算申请', 'F', '财务管理', 'F45', '0', '0', '0', '0', '0', 'TeacherBase/indexrole', null);
INSERT INTO `role_data` VALUES ('113', '156062065', '商家未结算订单', 'F', '财务管理', 'F50', '0', '0', '0', '0', '0', 'teacherBase/indexrolebm', null);
INSERT INTO `role_data` VALUES ('114', '156062085', '资金管理', 'F', '财务管理', 'F55', '0', '0', '0', '0', '0', 'teacherBase/indexrolebm', null);
INSERT INTO `role_data` VALUES ('115', '101038200', '管理员登录', 'A', '日志管理', 'C22', '0', '0', '0', '0', '0', 'logStaff/index', null);
INSERT INTO `role_data` VALUES ('116', '101038206', '登录日志', 'A', '日志管理', 'C24', '0', '0', '0', '0', '0', 'logUser/index', null);
INSERT INTO `role_data` VALUES ('117', '101038207', '操作日志', 'A', '日志管理', 'C28', '0', '0', '0', '0', '0', 'logOperates/index', null);
INSERT INTO `role_data` VALUES ('118', '101038215', '短信日志', 'A', '日志管理', 'C30', '0', '0', '0', '0', '0', 'logSms/index', null);
INSERT INTO `role_data` VALUES ('119', '126018402', '管理人员信息', 'D', '账号管理', 'D410', '0', '0', '0', '0', '0', 'staffs/index', null);
INSERT INTO `role_data` VALUES ('120', '126018419', '会员等级', 'D', '账号管理', 'D428', '0', '0', '0', '0', '0', 'ranks/index', null);
INSERT INTO `role_data` VALUES ('121', '126018420', '会员积分', 'D', '账号管理', 'D430', '0', '0', '0', '0', '0', 'baseInfo/waitzjCheck', null);
INSERT INTO `role_data` VALUES ('122', '126018421', '账号管理', 'D', '账号管理', 'D435', '0', '0', '0', '0', '0', 'baseInfo/zjCheck', null);
INSERT INTO `role_data` VALUES ('123', '126018451', '账号消费信息', 'D', '账号管理', 'D440', '0', '0', '0', '0', '0', 'baseInfo/zjCheckstate', null);
INSERT INTO `role_data` VALUES ('124', 'A', '产品信息', '101002036', '产品管理', '', '1', '6', '9', '0', '1', null, null);
INSERT INTO `role_data` VALUES ('125', 'A', '工单提交', '101029', '工单管理', '', '1', '17', '9', '0', '1', null, null);
INSERT INTO `role_data` VALUES ('126', 'A', '用户管理', '115300', '系统管理', '', '1', '35', '9', '0', '1', null, null);
INSERT INTO `role_data` VALUES ('127', 'E', '已上架商品', '13505', '商品上架管理', '', '1', '64', '9', '0', '0', null, null);
INSERT INTO `role_data` VALUES ('128', 'E', '订单管理', '135049', '订单管理', '', '1', '81', '9', '0', '0', null, null);
INSERT INTO `role_data` VALUES ('129', 'K', '投诉管理', '104010', '投诉管理', '', '1', '104', '9', '0', '0', null, null);
INSERT INTO `role_data` VALUES ('130', 'A', '产品信息', '101002036', '产品管理', '', '1', '6', '10', '0', '0', null, null);
INSERT INTO `role_data` VALUES ('131', 'A', '工单提交', '101029', '工单管理', '', '1', '17', '10', '0', '0', null, null);
INSERT INTO `role_data` VALUES ('132', 'A', '用户管理', '115300', '系统管理', '', '1', '35', '10', '0', '0', null, null);
INSERT INTO `role_data` VALUES ('133', 'A', '货品类别', '101002010', '系统维护', '', '1', '4', '10', '0', '1', null, null);
INSERT INTO `role_data` VALUES ('134', 'A', '何子健', '13874', '系统管理', '', '1', '110', '10', '0', '1', null, null);
INSERT INTO `role_data` VALUES ('135', 'A', '工单审批', '101029030', '工单管理', '', '1', '18', '10', '0', '1', null, null);
INSERT INTO `role_data` VALUES ('136', 'A', '流水管理', '101002168', '财务维护', '', '1', '14', '10', '0', '1', null, null);
INSERT INTO `role_data` VALUES ('137', 'A', '顾客信息', '101002009', '顾客总览', '', '1', '3', '10', '0', '1', null, null);
INSERT INTO `role_data` VALUES ('138', 'A', '工单查询', '101029031', '工单管理', '', '1', '19', '10', '0', '1', null, null);
INSERT INTO `role_data` VALUES ('139', 'A', '工单流程登记', '115027', '工单管理', '', '1', '24', '10', '0', '1', null, null);
INSERT INTO `role_data` VALUES ('140', 'A', '完成工单登记', '115027037', '工单管理', '', '1', '25', '10', '0', '1', null, null);
INSERT INTO `role_data` VALUES ('141', 'A', '在做流程查询', '115027302', '工单管理', '', '1', '26', '10', '0', '1', null, null);
INSERT INTO `role_data` VALUES ('142', 'A', '完成工单查询', '115028', '工单管理', '', '1', '27', '10', '0', '1', null, null);
INSERT INTO `role_data` VALUES ('143', 'A', '通过工单查询', '115028011', '工单管理', '', '1', '28', '10', '0', '1', null, null);
INSERT INTO `role_data` VALUES ('144', 'A', '角色管理', '115300172', '系统管理', '', '1', '36', '10', '0', '1', null, null);
INSERT INTO `role_data` VALUES ('145', 'A', '流程节点标签配置', '115300301', '系统管理', '', '1', '37', '10', '0', '1', null, null);
INSERT INTO `role_data` VALUES ('146', 'A', '金属材质', '101002014', '系统维护', '', '1', '5', '10', '0', '1', null, null);
INSERT INTO `role_data` VALUES ('147', 'A', '宝石类型', '101002041', '系统维护', '', '1', '7', '10', '0', '1', null, null);
INSERT INTO `role_data` VALUES ('148', 'A', '工单类型', '101002043', '系统维护', '', '1', '8', '10', '0', '1', null, null);
INSERT INTO `role_data` VALUES ('149', 'A', '客户类型', '101002061', '系统维护', '', '1', '9', '10', '0', '1', null, null);
INSERT INTO `role_data` VALUES ('150', 'A', '货品名称', '101002150', '系统维护', '', '1', '11', '10', '0', '1', null, null);
INSERT INTO `role_data` VALUES ('151', 'A', '进店类型', '101002165', '系统维护', '', '1', '10', '10', '0', '1', null, null);
INSERT INTO `role_data` VALUES ('152', 'A', '设计风格', '101002195', '系统维护', '', '1', '12', '10', '0', '1', null, null);
INSERT INTO `role_data` VALUES ('153', 'A', '库存类型', '101038', '系统维护', '', '1', '20', '10', '0', '1', null, null);
INSERT INTO `role_data` VALUES ('154', 'A', '用途', '101038006', '系统维护', '', '1', '21', '10', '0', '1', null, null);
INSERT INTO `role_data` VALUES ('155', 'A', '送人用途', '101038007', '系统维护', '', '1', '22', '10', '0', '1', null, null);
INSERT INTO `role_data` VALUES ('156', 'A', '支付方式', '101038185', '系统维护', '', '1', '23', '10', '0', '1', null, null);
INSERT INTO `role_data` VALUES ('157', 'A', '订单管理', '117071', '订单管理', '', '1', '38', '10', '0', '1', null, null);
INSERT INTO `role_data` VALUES ('158', 'A', '宝石类型维护', '101002', '证书管理', '', '1', '1', '10', '0', '1', null, null);
INSERT INTO `role_data` VALUES ('159', 'A', '货品证书维护', '101002003', '证书管理', '', '1', '2', '10', '0', '1', null, null);
INSERT INTO `role_data` VALUES ('160', 'A', '成本维护', '101002305', '财务维护', '', '1', '13', '10', '0', '1', null, null);
INSERT INTO `role_data` VALUES ('161', 'A', '库存管理', '101022004', '财务维护', '', '1', '15', '10', '0', '1', null, null);
INSERT INTO `role_data` VALUES ('162', 'A', '财务分析', '101022005', '财务维护', '', '1', '16', '10', '0', '1', null, null);
INSERT INTO `role_data` VALUES ('163', 'A', '已上架商品', '13505', '商品上架管理', '', '0', '64', '10', '0', '1', null, null);
INSERT INTO `role_data` VALUES ('164', 'A', '商品上架', '13875', '商品上架管理', '', '0', '112', '10', '0', '1', null, null);
INSERT INTO `role_data` VALUES ('165', 'A', '商品上架审核', '13876', '商品上架管理', '', '0', '113', '10', '0', '1', null, null);
INSERT INTO `role_data` VALUES ('166', 'A', '上架列表', '13877', '商品上架管理', '', '0', '114', '10', '0', '1', null, null);
INSERT INTO `role_data` VALUES ('167', 'A', '历史上架列表', '13878', '商品上架管理', '', '0', '115', '10', '0', '1', null, null);
INSERT INTO `role_data` VALUES ('168', 'A', '已上架商品', '13883', '商品上架管理', '', '0', '120', '10', '0', '1', null, null);
INSERT INTO `role_data` VALUES ('169', 'A', '订单管理', '135049', '订单管理', '', '0', '81', '10', '0', '1', null, null);
INSERT INTO `role_data` VALUES ('170', 'A', '订单管理', '135049050', '订单管理', '', '0', '82', '10', '0', '1', null, null);
INSERT INTO `role_data` VALUES ('171', 'A', '投诉订单', '135049051', '订单管理', '', '0', '83', '10', '0', '1', null, null);
INSERT INTO `role_data` VALUES ('172', 'A', '退款订单', '135049052', '订单管理', '', '0', '84', '10', '0', '1', null, null);
INSERT INTO `role_data` VALUES ('173', 'A', '积分抵扣报表', '135071328', '订单管理', '', '0', '85', '10', '0', '1', null, null);
INSERT INTO `role_data` VALUES ('174', 'A', '投诉管理', '104010', '投诉管理', '', '0', '104', '10', '0', '1', null, null);
INSERT INTO `role_data` VALUES ('175', 'A', '用户收藏或关注', '181082085', '投诉管理', '', '0', '106', '10', '0', '1', null, null);
INSERT INTO `role_data` VALUES ('176', 'A', '快递管理', '181082087', '投诉管理', '', '0', '109', '10', '0', '1', null, null);
INSERT INTO `role_data` VALUES ('177', 'A', '产品信息', '101002036', '产品管理', '', '1', '6', '12', '0', '0', null, null);
INSERT INTO `role_data` VALUES ('178', 'A', '工单提交', '101029', '工单管理', '', '1', '17', '12', '0', '0', null, null);
INSERT INTO `role_data` VALUES ('179', 'A', '工单审批', '101029030', '工单管理', '', '1', '18', '12', '0', '0', null, null);
INSERT INTO `role_data` VALUES ('180', 'A', '工单查询', '101029031', '工单管理', '', '1', '19', '12', '0', '0', null, null);
INSERT INTO `role_data` VALUES ('181', 'A', '用户管理', '115300', '系统管理', '', '1', '35', '12', '0', '0', null, null);
INSERT INTO `role_data` VALUES ('182', 'A', '角色管理', '115300172', '系统管理', '', '1', '36', '12', '0', '0', null, null);
INSERT INTO `role_data` VALUES ('183', 'A', '流程节点标签配置', '115300301', '系统管理', '', '1', '37', '12', '0', '0', null, null);
INSERT INTO `role_data` VALUES ('184', 'A', '货品类别', '101002010', '系统维护', '', '1', '4', '12', '0', '0', null, null);
INSERT INTO `role_data` VALUES ('185', 'A', '金属材质', '101002014', '系统维护', '', '1', '5', '12', '0', '0', null, null);
INSERT INTO `role_data` VALUES ('186', 'A', '宝石类型', '101002041', '系统维护', '', '1', '7', '12', '0', '0', null, null);
INSERT INTO `role_data` VALUES ('187', 'A', '工单类型', '101002043', '系统维护', '', '1', '8', '12', '0', '0', null, null);
INSERT INTO `role_data` VALUES ('188', 'A', '客户类型', '101002061', '系统维护', '', '1', '9', '12', '0', '0', null, null);
INSERT INTO `role_data` VALUES ('189', 'A', '货品名称', '101002150', '系统维护', '', '1', '11', '12', '0', '0', null, null);
INSERT INTO `role_data` VALUES ('190', 'A', '进店类型', '101002165', '系统维护', '', '1', '10', '12', '0', '0', null, null);
INSERT INTO `role_data` VALUES ('191', 'A', '设计风格', '101002195', '系统维护', '', '1', '12', '12', '0', '0', null, null);
INSERT INTO `role_data` VALUES ('192', 'A', '库存类型', '101038', '系统维护', '', '1', '20', '12', '0', '0', null, null);
INSERT INTO `role_data` VALUES ('193', 'A', '用途', '101038006', '系统维护', '', '1', '21', '12', '0', '0', null, null);
INSERT INTO `role_data` VALUES ('194', 'A', '送人用途', '101038007', '系统维护', '', '1', '22', '12', '0', '0', null, null);
INSERT INTO `role_data` VALUES ('195', 'A', '支付方式', '101038185', '系统维护', '', '1', '23', '12', '0', '0', null, null);
INSERT INTO `role_data` VALUES ('196', 'A', '订单管理', '117071', '订单管理', '', '1', '38', '12', '0', '0', null, null);
INSERT INTO `role_data` VALUES ('197', 'A', '宝石类型维护', '101002', '证书管理', '', '1', '1', '12', '0', '0', null, null);
INSERT INTO `role_data` VALUES ('198', 'A', '货品证书维护', '101002003', '证书管理', '', '1', '2', '12', '0', '0', null, null);
INSERT INTO `role_data` VALUES ('199', 'A', '流水管理', '101002168', '财务维护', '', '1', '14', '12', '0', '0', null, null);
INSERT INTO `role_data` VALUES ('200', 'A', '成本维护', '101002305', '财务维护', '', '1', '13', '12', '0', '0', null, null);
INSERT INTO `role_data` VALUES ('201', 'A', '库存管理', '101022004', '财务维护', '', '1', '15', '12', '0', '0', null, null);
INSERT INTO `role_data` VALUES ('202', 'A', '财务分析', '101022005', '财务维护', '', '1', '16', '12', '0', '0', null, null);
INSERT INTO `role_data` VALUES ('203', 'A', '顾客信息', '101002009', '顾客总览', '', '1', '3', '12', '0', '0', null, null);
...
CREATE TABLE `test_err` (
  ...
  PRIMARY KEY (`f_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3451 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
