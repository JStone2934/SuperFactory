<div class="box">    
   <?php 
       ...
       $coumnName='project_name,class_type,class_name,teacher_name,start_time:date,end_time:date,last_time:date,class_session,class_address,class_time,file:pic';
