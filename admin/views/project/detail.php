<div class="box">    
   <?php 
       $title=array('','工程详情','');
       $schcmd='关键字=keyword';
       $coumnName='project_code,relative_subjects,driving_question,discription,guiding_question,required_knowledge,success_skill,standard,NGSS,arrangement_file:pic';
